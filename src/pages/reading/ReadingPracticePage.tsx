  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div>
        ...
        <h1 className="text-xl font-bold text-stone-800 mt-2">{passage.title}</h1>
      </div>

      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <pre className="whitespace-pre-wrap font-sans text-sm text-stone-700 leading-relaxed">{passage.text}</pre>
        </Card>
        ...
        <div className="space-y-4">
            ...
            <Card key={q.id}>
              ...
              <div className="grid gap-2">
                {q.choices.map((choice, i) => {
                  ...
                  let stateClass = 'bg-white border-sand-200 hover:border-brand-400'
                  if (submitted) {
                    ...
                    else stateClass = 'bg-white border-sand-200 opacity-60'
                  } else if (isSelected) {
          ...
          {!submitted ? (
            ...
            <Card className="text-center">
              <p className="font-semibold text-stone-800">คะแนน {score}/{passage.questions.length}</p>
              <Link to="/reading">
